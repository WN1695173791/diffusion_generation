...
parser.add_argument('--ckpt', type=str, default='./logs_gen/GEN_2022_01_02__13_00_02/ckpt_0.000000_139000.pt')
parser.add_argument('--categories', type=str_list, default=['micropoint'])
parser.add_argument('--save_dir', type=str, default='./results')
parser.add_argument('--device', type=str, default='cuda')
# Datasets and loaders
parser.add_argument('--dataset_path', type=str, default='./data/micropoint.h5py')
